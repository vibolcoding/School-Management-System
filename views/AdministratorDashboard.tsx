...
const AdministratorDashboard: React.FC = () => {
  const staffOnLeave = MOCK_STAFF_DATA.filter(s => s.status === 'On Leave').length;
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <DashboardCard title="Total Enrolled Students" value={totalEnrolled.toString()} icon={<UsersIcon />} change="+5 this week" changeType="increase" />
        ...
        <DashboardCard title="Staff on Leave" value={staffOnLeave.toString()} icon={<CalendarIcon />} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          <h2 className="text-xl font-semibold mb-4 text-slate-800">New Staff Members</h2>
